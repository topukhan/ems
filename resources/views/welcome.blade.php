                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="list-unstyled team-info">
                                                    <li><img src="{{('ui/backend/assets/images/xs/avatar1.jpg" alt="Avatar"')}}"></li>
                            ...
                            <ul class="follow_us list-unstyled">
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{('ui/backend/assets/images/xs/avatar4.jpg" alt=""')}}">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{('ui/backend/assets/images/xs/avatar5.jpg" alt=""')}}">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{('ui/backend/assets/images/xs/avatar2.jpg" alt=""')}}">
                                            <div class="media-body">
                                ...
                                <li class="offline">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{('ui/backend/assets/images/xs/avatar1.jpg" alt=""')}}">
                                            <div class="media-body">
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="{{('ui/backend/assets/images/xs/avatar3.jpg" alt=""')}}">
                                            <div class="media-body">
