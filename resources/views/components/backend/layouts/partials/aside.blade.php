                    ...
                    <ul class="messages list-unstyled">
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{('ui/backend/assets/images/xs/avatar1.jpg" alt=""')}}">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object rounded-circle" src="{{('ui/backend/assets/images/xs/avatar2.jpg" alt=""')}}">
                                    <div class="media-body">
                        ...
                        <li>
                            <a href="javascript:void(0);">
                                <div class="media">"
                                    <img class="media-object rounded-circle" src="{{('ui/backend/assets/images/xs/avatar3.jpg" alt=""')}}">
                                    <div class="media-body">
                ...
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            ...
                            <li><img src="{{('ui/backend/assets/images/xs/avatar2.jpg" alt="Avatar"')}}"></li>
                            <li><img src="{{('ui/backend/assets/images/xs/avatar3.jpg" alt="Avatar"')}}"></li>
                            <li><img src="{{('ui/backend/assets/images/xs/avatar4.jpg" alt="Avatar"')}}"></li>
                        </ul>
                    </a>
                </div>
                <div class="body m-b-10">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small class="text-muted">Team</small></li>
                            <li><img src="{{('ui/backend/assets/images/xs/avatar6.jpg" alt="Avatar"')}}"></li>
                            <li><img src="{{('ui/backend/assets/images/xs/avatar7.jpg" alt="Avatar"')}}"></li>
                        </ul>
                    </a>
                </div>
                <div class="body">
                    <a href="javascript:void(0);">
                        ...
                        <ul class="list-unstyled team-info">
                            <li class="m-r-15"><small class="text-muted">Team</small></li>
                            <li><img src="{{('ui/backend/assets/images/xs/avatar8.jpg" alt="Avatar"')}}"></li>
                            <li><img src="{{('ui/backend/assets/images/xs/avatar9.jpg" alt="Avatar"')}}"></li>
                        </ul>
                    </a>
                </div>
            </div>
            ...
            <ul class="list">
                <li>
                    <div class="user-info m-b-20">
                        <div class="image">
                            <a href="profile.html"><img src="{{('ui/backend/assets/images/profile_av.jpg" alt="User"')}}"')}}"></a>
                        </div>
                        <div class="detail">
                            <h6>Michael</h6>
